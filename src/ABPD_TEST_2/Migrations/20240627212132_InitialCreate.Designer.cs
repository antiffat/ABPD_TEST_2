...
namespace ABPD_TEST_2.Migrations
{
    ...
    [Migration("20240627212132_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABPD_TEST_2.Models.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABPD_TEST_2.Models.CarManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABPD_TEST_2.Models.Competition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABPD_TEST_2.Models.Driver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABPD_TEST_2.Models.DriverCompetition", b =>
                {
            ...
            modelBuilder.Entity("ABPD_TEST_2.Models.Car", b =>
                {
                    b.HasOne("ABPD_TEST_2.Models.CarManufacturer", "CarManufacturer")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("ABPD_TEST_2.Models.Driver", b =>
                {
                    b.HasOne("ABPD_TEST_2.Models.Car", "Car")
                        .WithMany("Drivers")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ABPD_TEST_2.Models.DriverCompetition", b =>
                {
                    b.HasOne("ABPD_TEST_2.Models.Competition", "Competition")
                        .WithMany("DriverCompetitions")
                        .HasForeignKey("CompetitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ABPD_TEST_2.Models.Driver", "Driver")
                        .WithMany("DriverCompetitions")
